...
const SocialButton: React.FC<{
    ...
    return (
        <button
            ...
            aria-label={t('login.continueWith', { provider })}
...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onNavigate, onSocialLogin }) => {
  const { t } = useTranslations();
    ...
    <div className="w-full max-w-md">
      <div className="bg-white p-8 rounded-xl shadow-2xl border border-gray-200">
        ...
        <div className="mt-6 flex items-center">
          ...
          <span className="flex-shrink mx-4 text-gray-500 text-sm">{t('login.socialSeparator')}</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>
